<template>
    <section class="w-full mt-48">
        <div class="pg-title w-[75%] mx-auto pb-9">
            <h1 class="font-semibold">Privacy Policies</h1>
            <p class="font-semibold">プライバシーポリシー</p>
        </div>
        ...
        <!-- body -->
        <div class="policy-bd lg:w-[75%] mx-auto p-16 mt-16">
            <div class="mb-16">
                <h4 class="font-semibold pb-3">当社の個人情報の取り扱いについて</h4>
                <p class="">株式会社HORIZON GROUPでは、以下の通り個人情報の取り扱いについて定めます。</p>
            </div>
            
            <!-- 1 -->
            <div class="mb-9">
                <p class="font-bold mb-2">1. 収集する個人情報の内容</p>
                <p>
            ...
            <!-- 2 -->
            <div class="mb-9">
                <p class="font-bold mb-2">2. 個人情報の利用目的</p>
                <p>
            ...
            <!-- 3 -->
            <div class="mb-9">
                <p class="font-bold mb-2">3. 個人情報の開示について</p>
            ...
            <!-- 4 -->
            <div class="mb-9">
                <p class="font-bold mb-2">4. 個人情報の取扱いの委託について</p>
                <p>
            ...
            <!-- 5 -->
            <div class="mb-9">
                <p class="font-bold mb-2">5. 保有個人データに関するご本人の権利</p>
                <p>
            ...
            <!-- 6 -->
            <div class="mb-9">
                <p class="font-bold mb-2">6. クッキー（Cookie）の使用について</p>
                <p>
            ...
            <!-- 7 -->
            <div class="mb-9">
                <p class="font-bold mb-2">7. 安全管理措置について</p>
                <p>
            ...
            <!-- 8 -->
            <div class="mb-9">
                <p class="font-bold mb-2">8. 継続的な改善</p>
                <p>
            ...
            <!-- 9 -->
            <div class="mb-9">
                <p class="font-bold mb-2">9. お問い合わせ窓口について</p>
                <p>
